...
def classify_post_booking_turn(*, message: str) -> PostBookingTurnUnderstanding:
    ...
    if not normalized:
        return PostBookingTurnUnderstanding(
            decision=PostBookingTurnDecision.UNKNOWN,
    ...
    if cancel_signal is not None:
        return PostBookingTurnUnderstanding(
            decision=PostBookingTurnDecision.CANCEL_REQUEST,
            normalized_message=normalized,
    ...
    if reschedule_signal is not None:
        return PostBookingTurnUnderstanding(
            decision=PostBookingTurnDecision.RESCHEDULE_REQUEST,
            normalized_message=normalized,
    ...
    if new_scheduling_signal is not None:
        return PostBookingTurnUnderstanding(
            decision=PostBookingTurnDecision.NEW_SCHEDULING_REQUEST,
            normalized_message=normalized,
    ...
    if end_phrase is not None:
        return PostBookingTurnUnderstanding(
            decision=PostBookingTurnDecision.END_CONVERSATION,
            normalized_message=normalized,
    ...
    if needs_help_phrase is not None:
        return PostBookingTurnUnderstanding(
            decision=PostBookingTurnDecision.NEEDS_MORE_HELP,
            normalized_message=normalized,
