...
- [Retell Master Prompt v5](retell-master-prompt-v5.md) — active agent prompt (`retell-receptionist-v5`)
...
| Agent prompt | [Retell Master Prompt v5](retell-master-prompt-v5.md) published (`retell-receptionist-v5`) |
